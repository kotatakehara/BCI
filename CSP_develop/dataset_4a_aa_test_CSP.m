clear all;
S = load('data_set_4a_al_1000Hz.mat');
cnt = S.cnt;
pos = S.mrk.pos.';
class = S.mrk.y.';
cnt= 0.1*double(cnt);
cnt = bandpass(cnt,[8 15],1000);
s = load("true_labels_al.mat");
...
writematrix(feat_test_right,'feat_4a_1000Hz_Test/feat_test_right_al.txt')
writematrix(feat_test_foot,'feat_4a_1000Hz_Test/feat_test_foot_al.txt')