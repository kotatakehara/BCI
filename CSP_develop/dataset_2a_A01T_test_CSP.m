...
for i=1:test_nel
    Test_left(i,:,:) = A01T_left(i,:,:);
    Test_right(i,:,:) = A01T_right(i,:,:);
end
...
writematrix(feat_test_left,'feat_2a_250Hz_Test/feat_test_left_A09E.txt')
writematrix(feat_test_right,'feat_2a_250Hz_Test/feat_test_right_A09E.txt')