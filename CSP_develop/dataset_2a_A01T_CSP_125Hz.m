...
for i=1:train_nel
    Train_left_t(i,:,:) = A01T_left(random_index_left(i),:,:);
    Train_right_t(i,:,:) = A01T_right(random_index_right(i),:,:);
end
j = 1;
...
writematrix(feat_left,'feat_2a_125Hz_10/feat_left_A01T_10.txt')
writematrix(feat_right,'feat_2a_125Hz_10/feat_right_A01T_10.txt')
