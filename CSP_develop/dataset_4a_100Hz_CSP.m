clear all;
S = load('data_set_4a_aa_100Hz.mat');
cnt = S.cnt;
pos = S.mrk.pos.';
class = S.mrk.y.';
cnt= 0.1*double(cnt);
...
writematrix(feat_right_K1,'feat_4a_100Hz_30/feat_right_aa_100Hz_30.txt')
writematrix(feat_foot_K1,'feat_4a_100Hz_30/feat_foot_aa_100Hz_30.txt')